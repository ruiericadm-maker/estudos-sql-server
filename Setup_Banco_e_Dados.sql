...
CREATE TABLE dGerente(
	...
	data_de_contratacao VARCHAR(100) NOT NULL,
...
CREATE TABLE fContratos(
	...
	CONSTRAINT fcontrato_id_contrato_pk PRIMARY KEY(id_contrato),
	CONSTRAINT fcontrato_id_cliente_fk FOREIGN KEY(id_cliente) REFERENCES dCliente(id_cliente),
	CONSTRAINT fcontrato_id_gerente_fk FOREIGN KEY(id_gerente) REFERENCES dGerente(id_gerente),
